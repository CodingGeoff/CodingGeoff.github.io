<template>
  ...
  >
    <template v-slot:header>
      <div
        class="tw-flex tw-items-center tw-select-none"
      ...
      >
        ...
        >
          <div
            class="tw-h-full tw-px-3 tw-text-sm tw-font-normal tw-text-gray-50 tw-pt-2"
            style="
              white-space: nowrap;
    ...
    <template v-slot:content>
      <div
        class="tw-w-full tw-h-full tw-rounded-b-2xl tw-flex tw-flex-col-reverse"
      ...
      >
        ...
        <div class="tw-flex-grow tw-w-full tw-flex flex-row">
          <div
            class="tw-w-8 tw-h-full tw-px-1.5 tw-py-1"
            style="background-color: #f0f0f0; color: #a1b9cf"
          >
            <span class="tw-hidden">1</span>
          </div>
          <div
            class="tw-w-full tw-bg-white tw-pl-5 tw-pr-3 tw-py-1.5 change-srollbar"
            style="overflow: auto"
            :style="{ height: cont_height + 'px' }"
          >
            <markdown-it-vue
              class="md-body zoomined-frame"
              :content="content"
