**Forked from [GoodManWEN/GoodManWEN.github.io](https://github.com/GoodManWEN/GoodManWEN.github.io)**
...
```
git clone https://github.com/CodingGeoff/CodingGeoff.github.io.git
cd CodingGeoff.github.io.git
npm install
npm run serve
```
...
```
   ...
   e.g.
   https://CodingGeoff.github.io/#/desktop/post/README.md
```
